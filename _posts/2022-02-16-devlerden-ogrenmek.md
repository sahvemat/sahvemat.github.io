...
{% include chapter-toc.html dataset="devlerden_ogrenmek_toc" %}
...
<a class="next-section-nav" href="{{ '/posts/devlerden-ogrenmek/bolum-2/' | relative_url }}">
  <span class="next-section-label">Sıradaki Bölüm</span>
  <span class="next-section-title"><span class="next-section-text">Wojtaszek – Rapport</span> <span class="next-section-arrow">→</span></span>
</a>
</div>
