---
layout: post
title: "Whitsun Açık, Horvath ve Arlesli Kız 06"
author: "Tarık Selbes"
section: "Turnuva Günlüğü"
event: "Whitsun Açık · Münih Satranç Festivali"
date: 2026-06-03
permalink: /posts/whitsun-acik-horvath-ve-arlesli-kiz/bolum-6/
---
...
![Münih Filarmoni konseri]({{ '/assets/img/munich/konser-salonu.jpg' | relative_url }} "Münih Filarmoni'nin konser salonundan, orkestranın hazırlığı esnasında."){: loading="lazy" decoding="async"}
...
![Gasteig HP8]({{ '/assets/img/munich/gasteig.jpg' | relative_url }} "Konser salonunun bulunduğu Gasteig HP8 kompleksinin fuayesi."){: loading="lazy" decoding="async"}
...
<a class="next-section-nav next-section-nav--restart" href="{{ '/posts/whitsun-acik-horvath-ve-arlesli-kiz/' | relative_url }}">
  <span class="next-section-label">İlk sayfaya dön</span>
  <span class="next-section-title"><span class="next-section-text">Whitsun Açık, Horvath ve Arlesli Kız</span> <span class="next-section-arrow">↺</span></span>
</a>
</div>
