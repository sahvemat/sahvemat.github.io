---
layout: post
title: "Whitsun Açık, Horvath ve Arlesli Kız 03"
author: "Tarık Selbes"
...
![Hofbräuhaus München'de bir ayran]({{ '/assets/img/munich/hofbraeuhaus.jpg' | relative_url }} "Hofbraeuhaus München'in meşhur bardağında bir ayran."){: loading="lazy" decoding="async"}
...
![Jugend ohne Gott]({{ '/assets/img/munich/jugend-ohne-gott.jpg' | relative_url }} "Ödon von Horvath'ın Jugend ohne Gott'u, açık hava kahvesinde bir ayranla."){: loading="lazy" decoding="async"}
...
<div class="post-game" id="tur-4" data-pgn="{{ '/assets/pgn/munich/munich-r4.pgn' | relative_url }}"></div>

<div class="next-section-nav-wrap">
<a class="next-section-nav" href="{{ '/posts/whitsun-acik-horvath-ve-arlesli-kiz/bolum-4/' | relative_url }}">
  <span class="next-section-label">Sıradaki Bölüm</span>
  <span class="next-section-title"><span class="next-section-text">Cennetten Düşüş</span> <span class="next-section-arrow">→</span></span>
</a>
</div>
