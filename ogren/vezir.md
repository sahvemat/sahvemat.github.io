---
title: Vezir Nasıl Hareket Eder? — Satranç Öğren
layout: default
permalink: /ogren/vezir/
---
...
<div class="piece-content">
  <div class="piece-text-col">
    ...
    <ul class="move-rules">
      <li class="move-rule">
        ...
        <span class="move-rule-text">Yatay olarak istediği kadar kare gider (kale gibi).</span>
      </li>
      <li class="move-rule">
        <span class="move-rule-icon">↕</span>
        <span class="move-rule-text">Dikey olarak istediği kadar kare gider (kale gibi).</span>
      </li>
      <li class="move-rule">
        <span class="move-rule-icon">↗</span>
        <span class="move-rule-text">Dört çapraz doğrultuda istediği kadar kare gider (fil gibi).</span>
      </li>
      <li class="move-rule">
        <span class="move-rule-icon">✦</span>
  ...
  <div class="piece-boards-col">
    <div class="fen-demo-item">
      <span class="fen-demo-label">Merkezdeki vezir</span>
      <div class="position-card position-card--accent">
        <fen>8/8/8/8/3Q4/8/8/8 w - - 0 1</fen>
      </div>
