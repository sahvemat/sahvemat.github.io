---
title: Piyon Nasıl Hareket Eder? — Satranç Öğren
layout: default
permalink: /ogren/piyon/
---
...
<div class="piece-content">
  <div class="piece-text-col">
    ...
    <ul class="move-rules">
      <li class="move-rule">
        ...
        <span class="move-rule-text">Normalde bir kare düz ileri hareket eder.</span>
      </li>
      <li class="move-rule">
        <span class="move-rule-icon">↑↑</span>
        <span class="move-rule-text">İlk hamlede iki kare ileri gitme seçeneği vardır.</span>
      </li>
      <li class="move-rule">
        <span class="move-rule-icon">↗</span>
        <span class="move-rule-text">Düşman taşı yalnızca çapraz ileriden alınabilir.</span>
      </li>
      <li class="move-rule">
        <span class="move-rule-icon">✦</span>
  ...
  <div class="piece-boards-col">
    <div class="fen-demo-item">
      <span class="fen-demo-label">Başlangıç pozisyonu</span>
      <div class="position-card position-card--accent">
        <fen>8/8/8/8/8/8/3P4/8 w - - 0 1</fen>
      </div>
      <p class="fen-demo-caption">Piyon d2'de. İlk hamlede d3'e veya d4'e gidebilir.</p>
    </div>
    <div class="fen-demo-item">
      <span class="fen-demo-label">Yakalama pozisyonu</span>
      <div class="position-card position-card--dark">
        <fen>8/8/8/2p1p3/3P4/8/8/8 w - - 0 1</fen>
      </div>
      <p class="fen-demo-caption">d4'teki beyaz piyon, c5 veya e5'teki siyah piyonu çapraz alabilir.</p>
    </div>
  </div>
</div>
