---
title: At Nasıl Hareket Eder? — Satranç Öğren
layout: default
permalink: /ogren/at/
---
...
<div class="piece-content">
  <div class="piece-text-col">
    ...
    <ul class="move-rules">
      <li class="move-rule">
        ...
        <span class="move-rule-text">L şeklinde hareket eder: 2 kare + 1 kare, dik açıyla.</span>
      </li>
      <li class="move-rule">
        <span class="move-rule-icon">↟</span>
  ...
  <div class="piece-boards-col">
    <div class="fen-demo-item">
      <span class="fen-demo-label">Merkezdeki at — 8 hamle</span>
      <div class="position-card position-card--accent">
        <fen>8/8/8/8/3N4/8/8/8 w - - 0 1</fen>
      </div>
      <p class="fen-demo-caption">d4'teki at; b3, b5, c2, c6, e2, e6, f3, f5 karelerine atlayabilir.</p>
    </div>
    <div class="fen-demo-item">
      <span class="fen-demo-label">Köşedeki at — 2 hamle</span>
